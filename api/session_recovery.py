...
def _main() -> int:
    parser = argparse.ArgumentParser(description="Audit Agent session recovery state")
    ...
    parser.add_argument("--state-db", type=Path, default=None, help="optional Agent state.db path")
